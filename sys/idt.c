...
extern uint64_t syscall_handler();
...
void init_idt() {
	...
	offset1=(uint16_t)((uint64_t)syscall_handler & 0x000000000000FFFF);
        offset2=(uint16_t)(((uint64_t)syscall_handler >> 16) & 0x000000000000FFFF);
        offset3=(uint32_t)(((uint64_t)syscall_handler >> 32) & 0xFFFFFFFF);
